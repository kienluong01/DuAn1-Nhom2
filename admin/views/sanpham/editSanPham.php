  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-11">
            <h1>Sửa thông tin   sản phầm : <?=$sanPham['ten_san_pham'] ?> </h1>
          </div>
          <div class="col-sm-1">
...
<script>
  ...
  html = '<tr id="faqs-row-' + faqs_row + '">';
      html += '<td><img src=" https://th.bing.com/th?id=OIP.31nBttiCoBuGH3sYvN65iwAAAA&w=288&h=216&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2" style="width:50px; height:50px;  " alt=""></td>';
