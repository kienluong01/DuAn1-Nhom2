...
<head>
     ...
     <script data-cfasync="false" nonce="b3d97640-f76d-4aba-a1ff-0ebcbb5a7f0f">
          try {
               (function(w, d) {
                    ! function(j, k, l, m) {
                         if (j.zaraz) console.error("zaraz is loaded twice");
                              ...
                              j.zaraz._v = "5821";
                              j.zaraz._n = "b3d97640-f76d-4aba-a1ff-0ebcbb5a7f0f";
                              j.zaraz.q = [];
                              ...
                              j.zaraz.init = () => {
                                   ...
                                   r.defer = !0;
                                   for (const x of [localStorage, sessionStorage]) Object.keys(x || {}).filter((
                                        z => z.startsWith("_zaraz_"))).forEach((y => {
                                        try {
                                   ...
                                   r.src = "/cdn-cgi/zaraz/s.js?z=" + btoa(encodeURIComponent(JSON.stringify(j[
                                        l])));
     ...
     <div class="login-box">
          ...
          <div class="card card-outline card-primary">
               <div class="card-header text-center">
                    <a href="./assets/index2.html" class="h1"><b>Bán thực phẩm sạch</b></a>
               </div>
               <div class="card-body">
                    <?php
